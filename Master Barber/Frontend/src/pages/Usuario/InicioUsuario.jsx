            ...
            <div className=" text-white text-center p-5 mt-5">
              <div className="row row-cols-1 row-cols-md-2 g-4 mt-5">
                <div className="col text-white text-center p-5 pt-5 mt-5">
                  <h2 className="display-5 anton mt-5 pt-5">Horarios</h2>
                  <p className="mt-5">
                ...
                <div className="col mt-5 text-white text-center p-5 ">
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Lunes</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Martes</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">

                    <p className="mx-3 antonparabackend">Miercoles</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Jueves</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Viernes</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Sabado</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                  <div className="border-bottom d-flex justify-content-between mt-4">
                    <p className="mx-3 antonparabackend">Domingo</p>
                    <p className='text-warning mx-3 antonparabackend'>8.000</p>
                  </div>
                </div>
              </div>
