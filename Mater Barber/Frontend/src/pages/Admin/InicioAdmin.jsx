                    ...
                    <div className="container col border border mt-5 row col contenidol">
                        ...
                        <div className='row'>
                            <div className="col container mx-2">
                                ...
                                <p><a href="GestionarBarberos" className="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover mx-4 bebas">GESTIONBARBEROS</a></p>
                                <p><a href="Gestiondeventas" className="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover mx-4 bebas">GESTIONVENTAS</a></p>
                            </div>
                            <div className="col zoomhover2">
                                <img src="logomastershop.png" alt="" width="100%" height="90%" className="d-inline-block align-text-top mx-3 mt-1  " />
                            </div>
                        </div>
                    </div>
