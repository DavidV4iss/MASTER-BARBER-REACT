...
export default function InicioUsuario() {
    return (
        <div>
            <NavbarUserIndex />
            <div className="img position-fixed top-50 start-50 translate-middle row h-100 col-1 col-sm-12  mt-5 p-5 m-2"><img src="/LOGO.png" alt="" className='' /></div>
            <div className='container-fluid p-5 nab table-responsive col col-sm-12' id='homeuser'>
